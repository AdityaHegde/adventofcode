...
type problem struct {
  grid    *utils.ThreeDGrid[bool]
  air     *utils.ThreeDGrid[int]
...
func newProblem() *problem {
  return &problem{
    grid:    utils.NewThreeDGrid[bool](),
    air:     utils.NewThreeDGrid[int](),
